...
from exceptions.event_exception import EventNotFound
from models.event_model import EventModel, EventCreationModel
...
class EventService:
    ...
    async def get_all_event_by_folder_id(self, folder_id: str):
        """
        ...
        """
        events_from_database = await self.event_repository.get_events_by_folder_id(folder_id)
